...
{
    class Triangulo : Geometricos
    {
        public override void Saludo() //Metodo para el Saludo de que es un Triangulo
        {
            Console.WriteLine("¡Esto es un Triangulo!"); //Imprimir Saludo de que figura es
        }
        ...
        public override void CalcularArea(int Lado1=5, int Lado2=10) //Metodo para Calcular el Area recibiendo parametros
        {
            ...
            Area = (Lado1 * Lado2)/2; //Operacion para calcular el Area

            Console.WriteLine("El Area del Triangulo es: " + Area + " metros cuadrados."); //Imprimir los resultados
        }
        ...
        public override void CalcularPerimetro(int Lado1=5, int Lado2=10) //Metodo para Calcular el Perimetro recibiendo parametros
        {
            ...
            Perimetro = Lado1+Lado2+Lado1; //Operacion para calcular el Perimetro
